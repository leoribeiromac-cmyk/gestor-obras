/* Obra Ranário — Estrada Vicinal SQE-479 (DER-SP, contrato 22.926-0).
   Serviços FÍSICOS, sem valores e sem itens indiretos.
   Fonte: ANEXO 1 - QDR - 19_02 (2) FINAL.xlsx — coluna PROPOSTO, isto é,
   as quantidades DEPOIS do aditivo/supressão (contrato de R$ 6.471.909,89).
   Item com quantidade proposta zerada saiu do contrato e não está aqui.
   Cronograma: Rev.7 (a assinada pelo fiscal), % de cada frente por mês.
   Ficaram de fora, por serem indiretos: transportes (m³*km), placa
   institucional e sua manutenção, canteiro de obras, equipe de projeto,
   ensaios e serviços terceirizados. */
window.OBRAS = window.OBRAS || {};
window.OBRAS["ranario"] = {
  "id": "ranario",
